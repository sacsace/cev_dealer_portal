...
-- Migration: 20250626140000_add_fitments
-- CreateTable
...
SELECT gen_random_uuid()::text, '2d67de68aa0ad633394107a162d72fc81405e83b4c4398e87092716cd5a460d1', NOW(), '20250626120000_init', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM "_prisma_migrations" WHERE "migration_name" = '20250626120000_init');

INSERT INTO "_prisma_migrations" ("id", "checksum", "finished_at", "migration_name", "started_at", "applied_steps_count")
SELECT gen_random_uuid()::text, '5c73c9b842c093d34926ae2b556c457dc1a5680de7967f41162ba62a10185b6a', NOW(), '20250626140000_add_fitments', NOW(), 1
WHERE NOT EXISTS (SELECT 1 FROM "_prisma_migrations" WHERE "migration_name" = '20250626140000_add_fitments');
